...
namespace QQ
{
    ...
    public class UIImage : Image, IMeshModifier
    {
        ...
        /// <summary>
        /// <see cref="ImageEditor"/>
        /// </summary>
        [CustomEditor(typeof(UIImage), true)]
        private class UIImageEditor : GraphicEditor
        {
            UIImage ownerImg;
            ...
            protected override void OnEnable()
            {
                ...
                //추가
                m_FlipX = serializedObject.FindProperty(nameof(ownerImg.flipX));
                m_FlipY = serializedObject.FindProperty(nameof(ownerImg.flipY));
            }
            ...
            public override void OnInspectorGUI()
            {
                ...
                RectTransform rect = ownerImg.GetComponent<RectTransform>();
                ...
                EditorGUILayout.PropertyField(m_FlipX, new GUIContent("Flip X"));
                EditorGUILayout.PropertyField(m_FlipY, new GUIContent("Flip Y"));
                    ...
                    if (EditorGUILayout.BeginFadeGroup(m_ShowFilled.faded))
                    {
                        ...
                        switch ((Image.FillMethod)m_FillMethod.enumValueIndex)
                        {
                            case Image.FillMethod.Horizontal:
                                EditorGUIPopupCopy(shapeRect, m_FillOrigin, Styles.OriginHorizontalStyle, Styles.text);
                                break;
                            case Image.FillMethod.Vertical:
                                EditorGUIPopupCopy(shapeRect, m_FillOrigin, Styles.OriginVerticalStyle, Styles.text);
                                break;
                            case Image.FillMethod.Radial90:
                                EditorGUIPopupCopy(shapeRect, m_FillOrigin, Styles.Origin90Style, Styles.text);
                                break;
                            case Image.FillMethod.Radial180:
                                EditorGUIPopupCopy(shapeRect, m_FillOrigin, Styles.Origin180Style, Styles.text);
                                break;
                            case Image.FillMethod.Radial360:
                                EditorGUIPopupCopy(shapeRect, m_FillOrigin, Styles.Origin360Style, Styles.text);
                                break;
                        }
            ...
            public override void OnPreviewGUI(Rect rect, GUIStyle background)
            {
                ...
                SpriteDrawUtilityCopy.DrawSprite(sf, rect, image.canvasRenderer.GetColor());
            }
            ...
            private void EditorGUIPopupCopy(Rect position, SerializedProperty property, GUIContent[] displayedOptions, GUIContent label)
            {
            ...
            #region SpriteDrawUtility
            private static class SpriteDrawUtilityCopy
            {
